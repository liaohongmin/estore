...
<body>
    ...
    <div class="container4">
        	...
        	<ul class="c4_b1_boxes">
        		<c:forEach items="${list }" var="book" varStatus="status">
        			...
        			<div class="c4_b1_box_txt">
                        ...
                        <h2><a href="LookBookServlet?id=${book.id }">立即抢购</a></h2>
                    </div>
                    </li>
                 </c:forEach>
            </ul>
        ...
        <div class="c4_b2">
            <h1 class="c4_b2_x">
            	<a href="ListServlet?parentCatName=${parentCategoryName }">${parentCategoryName }&nbsp;&nbsp;></a>
                <span><a href="ListServlet?parentCatName=${parentCategoryName }">${parentCategoryName }</a></span>
            </h1>
                     ...
                     <li class="c4_b5_c_box">
                    	...
                    	<div class="c4_b5_c_box_pic">
                        	<div class="c4b5_pic_view">
                            	<a href="LookBookServlet?id=${b.id }"><img src="${b.image }"></a>
                            </div>
                        </div>
                        <!--价钱-->
                        <div class="c4_b5_c_box_txt">
                        	<h1>￥ ${b.price }</h1>
                            <h2><a href="LookBookServlet?id=${b.id }">${b.name }</a></h2>
                        </div>
                        <!--购买等操作-->
                        <div class="c4b5_el">
                        	<div class="c4b5_el_x">
                        ...
                        <form action="InListShopServlet" id="addCar" >
		                    	<div class="pro_buy">
