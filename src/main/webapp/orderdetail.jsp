        ...
        <table>
            ...
            <tbody>
            	<c:forEach items="${OrderLineList }" var="item" varStatus="status">
                    ...
                    <td>价格：<span>${item.book.price }</span></td>
                    <td>数量：<span>${item.num }</span></td>
                    <td>小计：<span>${item.book.price * item.num }</span></td>
                </tr>
            	</c:forEach>
                
                <tr>
                    <td colspan="5" class="count">合计：<span>${totalPrice }</span></td>
                </tr>
            </tbody>
        </table>
