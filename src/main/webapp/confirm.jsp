...
<body>
    ...
    <div class="content">
		...
		<form action="CommitOrder" name="orderForm">
    		...
    		<div class="centerTop">
    			...
    			<ul class="adres">
					<c:forEach items="${ShopAddresslist }" var="item">
			    		<li>
			    			<input type="radio" name="shipAddId" value="${item.id }" style="width:50px">
			    			收货人姓名：${item.receiveName }&nbsp;&nbsp;&nbsp;收货电话：${item.phone }&nbsp;&nbsp;&nbsp;收货地址：${item.address }
			    		</li>
			    	</c:forEach>
		    	</ul>
    		...
    		<div class="bigDiv">
    			<div class="twoDiv">
    				...
    				<c:forEach items="${shopCar }" var="item">
    					<ul class="oneUL">
    					<li>
    						<img src="${item.value.book.image  }" class="pic">
    						<p>${item.value.book.category.name  }&nbsp;&nbsp;${item.value.book.name  }&nbsp;&nbsp;</p>
    						<p><font>¥${item.value.book.price  }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×${item.value.num  }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
    		...
    		<div class="money">
    			<span><font>${totalNum }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${totalPrice }</span>
    			<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>

    			<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${totalPrice }</span>
    		</div>
    		<div class="submit">
    			<span>应付金额：<font>¥${totalPrice }</font><input type="image" src="images/21_03.png"></span>
    		</div>
			</form>
    	</div>
