                ...
                <div class="cn5topy_2">
                    ...
                    <div class="pro_selects">
                        ...
                        <div class="pro_select">
                            ...
                            <ul class="pro_select_vals">
                                <li> 出版时间：<fmt:formatDate value="${book.pubDate}" pattern="yyyy-MM-dd"/></li>
                                <li>包装：平装</li>
                                <li>正文语种：中文</li>
                            </ul>
                        </div>
                    </div>
				<form action="ShopServlet" id="addCar" >
                    <div class="pro_buy">
                        ...
                        <div class="pro_addshop" onclick="submitForm()">加入购物车</div>
                         <%-- <div class="pro_addshop"><a href="ShopServlet?id=${book.id}">加入购物车</a></div> --%>
                    </div>
				</form>
                    <div class="pro_ship">
                        <div>
